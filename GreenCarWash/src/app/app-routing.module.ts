...
import { EditaddonsComponent } from './admin-microservice/viewaddons/editaddons/editaddons.component';
import { EditCarDetailsComponent } from './admin-microservice/viewcardetails/edit-car-details/edit-car-details.component';
import { EditpromosComponent } from './admin-microservice/viewpromos/editpromos/editpromos.component';
  ...
  { path:'home', component: HomeComponent },
   {
    ...
    },
    {
      ...
      children:[
        ...
        {path:'edit_addons/:id',component:EditaddonsComponent},
        {path:'edit_cardetails/:id',component:EditCarDetailsComponent},
        {path:'edit_promos/:id',component:EditpromosComponent}
      ]
    },
